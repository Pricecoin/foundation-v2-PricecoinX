...
const Loader = function(logger, configMain) {
  ...
  this.handleConfigs = function() {
    ...
    if (fs.existsSync(normalizedPath + 'pricecoinx.js')) {
      config = require(normalizedPath + 'pricecoinx.js');
      ...
      throw new Error('Unable to find pricecoinx.js file. Read the installation/setup instructions');
    }
    return config;
  };
};
