...
config.primary.recipients[0].address = 'prc1qcd3ww7yc75tl63j3xukmphchn0eedg5ss8dzrq';
...
function mockSetupSettings(pool, callback) {
  nock('http://127.0.0.1:2332')
    .post('/').reply(200, JSON.stringify([
      { id: 'nocktest', error: null, result: { isvalid: true, address: 'prc1qcd3ww7yc75tl63j3xukmphchn0eedg5ss8dzrq' }},
...
function mockClient() {
  ...
  client.id = 'test';
  client.addrPrimary = 'prc1qcd3ww7yc75tl63j3xukmphchn0eedg5ss8dzrq';
...
describe('Test pool functionality', () => {
  ...
  test('Test pool settings setup [2]', (done) => {
    ...
    mockSetupDaemons(pool, () => {
      ...
      pool.setupSettings(() => {
        expect(configCopy.primary.address).toBe('prc1qcd3ww7yc75tl63j3xukmphchn0eedg5ss8dzrq');
  ...
  test('Test pool settings setup [3]', (done) => {
    ...
    mockSetupDaemons(pool, () => {
      nock('http://127.0.0.1:2332')
        .post('/').reply(200, JSON.stringify([
          { id: 'nocktest', error: true, result: { isvalid: true, address: 'prc1qcd3ww7yc75tl63j3xukmphchn0eedg5ss8dzrq' }},
          { id: 'nocktest', error: null, result: { networkhashps: 0 }},
          { id: 'nocktest', error: null, result: { chain: 'main', difficulty: 0 }},
          { id: 'nocktest', error: null, result: { protocolversion: 1, connections: 1 }},
        ]));
  ...
  test('Test pool settings setup [4]', (done) => {
    ...
    mockSetupDaemons(pool, () => {
      nock('http://127.0.0.1:2332')
        .post('/').reply(200, JSON.stringify([
          { id: 'nocktest', error: null, result: { isvalid: false, address: 'prc1qcd3ww7yc75tl63j3xukmphchn0eedg5ss8dzrq' }},
          { id: 'nocktest', error: null, result: { networkhashps: 0 }},
          { id: 'nocktest', error: null, result: { chain: 'main', difficulty: 0 }},
          { id: 'nocktest', error: null, result: { protocolversion: 1, connections: 1 }},
        ]));
    ...
    pool.on('pool.log', (type, text) => {
      if (type !== 'debug') {
        ...
        if (response.length === 2) {
          pool.network.on('network.stopped', () => done());
          expect(response[1][0]).toBe('log');
          expect(response[1][1]).toBe('Difficulty update queued for worker: prc1qcd3ww7yc75tl63j3xukmphchn0eedg5ss8dzrq (8)');
          pool.network.stopNetwork();
        }
      }
    });
    ...
    pool.on('pool.log', (type, text) => {
      if (type !== 'debug') {
        ...
        if (response.length === 2) {
          ...
          expect(response[0][1]).toBe('Network difficulty (0) is lower than the difficulty on port 3002 (32)');
          expect(response[1][0]).toBe('log');
          expect(response[1][1]).toBe('Difficulty updated successfully for worker: prc1qcd3ww7yc75tl63j3xukmphchn0eedg5ss8dzrq (8)');
          pool.network.stopNetwork();
        }
      }
    });
    ...
    mockSetupDaemons(pool, () => {
      nock('http://127.0.0.1:2332')
        ...
        .reply(200, JSON.stringify({
          id: 'nocktest',
          error: null,
          result: { isvalid: true, address: 'prc1qcd3ww7yc75tl63j3xukmphchn0eedg5ss8dzrq' }
        }));
      pool.checkWorker(pool.primary.daemon, 'prc1qcd3ww7yc75tl63j3xukmphchn0eedg5ss8dzrq', (valid) => {
  ...
  test('Test pool stratum authentication [2]', (done) => {
    ...
    mockSetupDaemons(pool, () => {
      ...
      pool.checkWorker(pool.primary.daemon, 'prc1qcd3ww7yc75tl63j3xukmphchn0eedg5ss8dzrq.worker1', (valid) => {
        expect(valid).toBe(true);
        done();
      });
    });
  ...
  test('Test pool stratum authentication [3]', (done) => {
    ...
    mockSetupDaemons(pool, () => {
      ...
      pool.checkPrimaryWorker('0.0.0.0', 3001, 'prc1qcd3ww7yc75tl63j3xukmphchn0eedg5ss8dzrq', (valid) => {
        expect(valid).toBe(true);
        done();
      });
    });
    ...
    mockSetupDaemons(pool, () => {
      nock('http://127.0.0.1:2332')
        ...
        .reply(200, JSON.stringify({
          id: 'nocktest',
          error: null,
          result: { isvalid: false, address: 'prc1qcd3ww7yc75tl63j3xukmphchn0eedg5ss8dzrq' }
        }));
      pool.checkPrimaryWorker('0.0.0.0', 3001, 'prc1qcd3ww7yc75tl63j3xukmphchn0eedg5ss8dzrq', () => {}, (result) => {
  ...
  test('Test pool stratum authentication [6]', (done) => {
    ...
    mockSetupDaemons(pool, () => {
      ...
      pool.checkAuxiliaryWorker('0.0.0.0', 3001, 'prc1qcd3ww7yc75tl63j3xukmphchn0eedg5ss8dzrq', (valid) => {
        expect(valid).toBe(true);
        done();
      });
    });
  ...
  test('Test pool stratum authentication [7]', (done) => {
    ...
    mockSetupDaemons(pool, () => {
      ...
      pool.checkAuxiliaryWorker('0.0.0.0', 3001, 'prc1qcd3ww7yc75tl63j3xukmphchn0eedg5ss8dzrq', () => {}, (result) => {
        expect(result).toStrictEqual({ 'error': null, 'authorized': false, 'disconnect': false });
        done();
      });
    });
  ...
  test('Test pool stratum authentication [10]', (done) => {
    ...
    mockSetupDaemons(pool, () => {
      ...
      pool.authorizeWorker('0.0.0.0', 3001, 'prc1qcd3ww7yc75tl63j3xukmphchn0eedg5ss8dzrq', null, 'test', (result) => {
  ...
  test('Test pool stratum authentication [11]', (done) => {
    ...
    mockSetupDaemons(pool, () => {
      ...
      pool.authorizeWorker('0.0.0.0', 3001, 'prc1qcd3ww7yc75tl63j3xukmphchn0eedg5ss8dzrq', 'prc1qcd3ww7yc75tl63j3xukmphchn0eedg5ss8dzrq', 'test', (result) => {
        expect(result).toStrictEqual({ 'error': null, 'authorized': true, 'disconnect': false });
        done();
      });
    });
  ...
  test('Test pool workers handling [1]', () => {
    ...
    const blocks1 = {
      ...
      miner: 'prc1qcd3ww7yc75tl63j3xukmphchn0eedg5ss8dzrq',
      worker: 'prc1qcd3ww7yc75tl63j3xukmphchn0eedg5ss8dzrq.worker1',
      category: 'immature',
      confirmations: 3,
    ...
    const worker1 = {
      ...
      miner: 'prc1qcd3ww7yc75tl63j3xukmphchn0eedg5ss8dzrq',
      worker: 'prc1qcd3ww7yc75tl63j3xukmphchn0eedg5ss8dzrq.worker4',
      identifier: 'master',
      invalid: 0,
      round: '15c8343c-9751-4c67-aafa-29ff296da484',
      solo: false,
    ...
    const expected = { 'prc1qcd3ww7yc75tl63j3xukmphchn0eedg5ss8dzrq': { 'immature': 10000, 'generate': 0 }};
  ...
  test('Test pool workers handling [2]', () => {
    ...
    const expected = { 'prc1qcd3ww7yc75tl63j3xukmphchn0eedg5ss8dzrq': { 'generate': 0, 'immature': 80000 }};
  ...
  test('Test pool workers handling [3]', () => {
    ...
    const expected = {
      'prc1qcd3ww7yc75tl63j3xukmphchn0eedg5ss8dzrq': { 'immature': 5000, 'generate': 0 },
  ...
  test('Test pool workers handling [4]', () => {
    ...
    worker2.times = 49.1;
    const expected = {
      'prc1qcd3ww7yc75tl63j3xukmphchn0eedg5ss8dzrq': { 'immature': 8474.10994411, 'generate': 0 },
  ...
  test('Test pool workers handling [5]', () => {
    ...
    const expected = { 'prc1qcd3ww7yc75tl63j3xukmphchn0eedg5ss8dzrq': { 'generate': 10000, 'immature': 0 }};
    pool.handlePrimaryWorkers([blocks1], [[worker1]], false, (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
  ...
  test('Test pool workers handling [6]', () => {
    ...
    const expected = { 'prc1qcd3ww7yc75tl63j3xukmphchn0eedg5ss8dzrq': { 'immature': 0, 'generate': 80000 }};
    pool.handlePrimaryWorkers([blocks1, blocks1], [[worker1], [worker1]], false, (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
  ...
  test('Test pool workers handling [9]', () => {
    ...
    const expected = { 'prc1qcd3ww7yc75tl63j3xukmphchn0eedg5ss8dzrq': { 'immature': 0, 'generate': -10000 }};
    pool.handlePrimaryWorkers([blocks1], [[worker1]], false, (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
  ...
  test('Test pool workers handling [12]', () => {
    ...
    const expected = {
      'prc1qcd3ww7yc75tl63j3xukmphchn0eedg5ss8dzrq': { 'immature': 9570.0056964, 'generate': 0 },
  ...
  test('Test pool workers handling [14]', () => {
    ...
    const expected = { 'prc1qcd3ww7yc75tl63j3xukmphchn0eedg5ss8dzrq': { 'immature': -10000, 'generate': 10000 }};
    pool.handlePrimaryWorkers([blocks1], [[worker1]], true, (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
